...
final class SunsoakUITests: XCTestCase {
    ...
    func testFreeLimitTriggersPaywall() throws {
        ...
        XCTAssertTrue(app.buttons["unlockProButton"].waitForExistence(timeout: 5) || app.staticTexts["Sunsoak Pro"].waitForExistence(timeout: 5))
    }
