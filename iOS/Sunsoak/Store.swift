...
final class Store: ObservableObject {
    ...
    /// Free tier allows this many total session entries before the paywall appears.
    ...
    init() {
        ...
        entriesURL = support.appendingPathComponent("sunsoak_entries.json")
        settingsURL = support.appendingPathComponent("sunsoak_settings.json")
        load()
        if entries.isEmpty {
            seed()
        }
